...
[ExportService(Queue)]
public sealed class QueueService(SoapControlEndpoint endpoint, Uri controlUri) : SoapActionInvoker(endpoint, controlUri, Queue), IUpnpService, IUpnpServiceFactory<QueueService>
{
