...
public class ChangePowerState : YeelightDeviceFeature
{
    private readonly string propGetPower;
    private readonly string propSetPower;
    private readonly string propSetToggle;

    public ChangePowerState(YeelightDevice device) : this(device, "power", "set_power", "toggle") { }

    protected ChangePowerState(YeelightDevice device, string propGetPower, string propSetPower, string propSetToggle) :
        base(device)
    {
