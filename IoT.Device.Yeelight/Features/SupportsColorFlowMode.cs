...
public class SupportsColorFlowMode : YeelightDeviceFeature
{
    ...
    protected SupportsColorFlowMode(YeelightDevice device, string startName, string stopName,
    ...
    public SupportsColorFlowMode(YeelightDevice device) :
